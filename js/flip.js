    ...
    (function (t, e, cn) {
        ...
        if (t && "MutationObserver" in t && "requestAnimationFrame" in t) {
            var n = (function () {
                    ...
                    jt = function (t, e, n) {
                        if (t.lastAppliedStyles !== n) {
                            ...
                            t.style.transitionIn && t.style.transitionIn.length
                                ...
                                r && i && ((t.transitionIn = Dt(r)), (t.transitionOut = Dt(i)), (t.skipToTransitionInEnd = Dt(r.map(qt))), (t.skipToTransitionOutEnd = Dt(i.map(qt)))),
                                (t.dirty = !0);
                        }
                    },
                    qt = function (t) {
                ...
                function Yt(t, e, n) {
                    return (r = t), (i = e), (o = n), (a = { definitions: [] }), Object.assign({}, A(a, r), M(a), k(a, i), E(a, G, at, o), _(a));
                    var r, i, o, a;
                }
                function Vt(t, e, n) {
                    var r = c(s.VIEW, t);
                    return r
                        ? r({
                              ...
                              Data: { request: Ee },
                              Date: { performance: ke },
                              View: { rooter: A, drawer: E, updater: M, styler: Nt, grouper: k, resizer: x, destroyer: _ },
                          })(e, n)
                        : null;
                }
                function Bt(t) {
                ...
                function ze(r, e) {
                    ...
                    var o = t.reduce(
                        function (t, e) {
                            var n;
                            return (
                                /(?:mon|tues|wednes|thurs|fri|satur|sun)day/.test(e) && (t.day = C[(n = e).charAt(0).toUpperCase() + n.slice(1)]),
                                /^at/.test(e) ? (t.time = Pe(O(r), e.substr(3))) : /wait/.test(e) && (t.idle = Fe(e.substr(5))),
                                t
                            );
                        },
                ...
                function je(t, e) {
                    return /januari|februari|march|april|may|june|july|august|september|october|november|december/.test(e)
                              ...
                              var o = t.reduce(
                                  function (t, e) {
                                      return (
                                          ...
                                          /^at/.test(e) ? (t.time = Pe(O(n), e.substr(3))) : /wait/.test(e) ? (t.idle = Fe(e.substr(5))) : /^[\a-zA-Z]+$/.test(e) && (t.month = e),
                                          t
                                      );
                                  },
                        ...
                        ? (function (n, e) {
                              ...
                              var o = t.reduce(
                                  function (t, e) {
                                      return (
                                          /([\d]+th|\dst|\dnd|first|last)/.test(e) && (t.day = /^[\d]/.test(e) ? parseInt(e, 10) : "first" === e ? 1 : e),
                                          /^at/.test(e) ? (t.time = Pe(O(n), e.substr(3))) : /wait/.test(e) && (t.idle = Fe(e.substr(5))),
                                          t
                                      );
                                  },
                                  { idle: null, day: null, time: null, date: null, dist: null, wait: !1 }
                        ...
                        ? ((n = t),
                          ...
                          null !== r.idle && i >= h.Day - r.idle ? (r.wait = !0) : ((r.dist = i), (r.date = O(r.time))),
                          r)
                ...
                var Ye = [],
                    ...
                    Je = function (t, e) {
                        var n = e.match(/((?:[\d]+\s)?(?:hours|hour|minutes|minute|seconds|second))|((?:from|till)\s[\d]+(?::[\d]+)?(?::[\d]+)?)|(wait\s[\d]+\s[a-z]+)/g).reduce(
                            ...
                            { idle: null, interval: null, date: null, dist: null, wait: !1, from: Pe(O(t), "0"), till: Pe(O(t), "23:59:59:999") }
                        );
                                        ...
                                        function () {
                                            ...
                                            if (
                                                ...
                                                return (
                                                    ...
                                                    u.nextScheduledDate && (u.previouslyScheduledDate = O(u.nextScheduledDate)),
                                                    (u.nextScheduledDate = null === s ? null : O(s)),
                                                    void u.onwait(u.previouslyScheduledDate ? O(u.previouslyScheduledDate) : null)
                                                );
                                            (u.nextScheduledDate = O(s)),
                                                null === l && u.onresume(O(s)),
                                                (null === l || (l !== cn && ((e = s), l.getTime() !== e.getTime()))) && (u.onrepeat(O(s), l ? O(l) : null), l && (u.previouslyScheduledDate = O(l))),
                                                (l = O(s)),
